...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2024-09-30 17:10:43+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.2.34.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
